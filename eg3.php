...
<div class="">
			...
			<table cellspacing="7" cellpadding="10">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="date" name="dob" min="1940-01-01" max="2016-06-30"> 
                                    </td>
                              ...
                              <tr>
								...
								<input type="button" class="calculate" value="Calculate" onClick="computeform(this.form)">
								...
								<tr>
								     <td>
								          <input type="submit"  class="addbtn"  value="ADD" name="submit" ><!--class="button1"-->
								    </td>
							   	   <td>
							           <input type="reset" class="resetbtn" value="Reset" onClick="ClearForm(this.form)"><!--class="button5"-->
